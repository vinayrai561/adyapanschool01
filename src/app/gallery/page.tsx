      ...
      <nav className="sticky top-0 z-50 bg-[#1a202c] border-b border-gray-800">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium">
            {[['/', 'Home'], ['/about', 'About Us'], ['/gallery', 'Our Gallery'], ['/company', 'For Companies']].map(([h, l]) => (
          ...
          <div className="flex items-center gap-6">
            ...
            <Link href="/auth" className="px-6 py-2 bg-[#ffa800] text-white rounded-full text-sm font-semibold hover:bg-[#e69500] transition-colors">
              Sign Up
            </Link>
          </div>
        </div>
