...
/* â”€â”€ Floating label input â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
function FloatInput({
...
/* â”€â”€ Role card â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
function SignupContent() {
  ...
  const formattedAmount = Number.isFinite(normalizedAmount)
    ? `â‚¹${normalizedAmount!.toLocaleString('en-IN')}` : null;
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-amber-50 to-white px-4 py-16 relative overflow-hidden">
      ...
      >
        <div className="bg-white rounded-3xl shadow-2xl shadow-orange-100/50 border border-gray-100 overflow-hidden">
          ...
          <div className="px-8 py-8">
            ...
            <div className="text-center mb-6">
              ...
              <h1 className="text-2xl font-extrabold text-gray-900">Create your account âœ¨</h1>
            ...
            {(selectedProgram || selectedAmount) && (
              <motion.div initial={{ opacity: 0, y: -8 }} animate={{ opacity: 1, y: 0 }}
                ...
                <p className="text-sm text-green-700">
                  ...
                  {formattedAmount && <> â€” <strong>{formattedAmount}</strong></>}
                </p>
              </motion.div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-3.5">
              {/* Name fields â€” animate when role changes */}
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => alert('Google Sign Up â€” integration needed')}
        ...
        <div className="flex items-center justify-center gap-6 mt-5">
          {['ðŸ”’ Secure signup', 'ðŸŽ“ 10K+ students', 'âœ… Free to join'].map(t => (
