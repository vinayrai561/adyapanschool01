...
const MOMENTS = [
  ...
  { src: '/images/jag.jpeg?v=20260513', alt: 'Professional portrait', area: 'b' },
  { src: '/images/vit.jpeg?v=20260513', alt: 'Team office visit', area: 'h' },
...
const CARDS = [
  ...
  { src: '/images/jag.jpeg?v=20260513',   label: 'PORTRAIT',     bg: 'bg-slate-700',  col: '#334155' },
  { src: '/images/vit.jpeg?v=20260513',   label: 'TEAM',         bg: 'bg-sky-700',    col: '#0369a1' },
