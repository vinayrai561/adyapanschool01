...
export default function CompanyDashboard() {
  ...
  const formattedSelectedAmount =
    user?.selectedAmount != null ? `â‚¹${user.selectedAmount.toLocaleString('en-IN')}` : null;
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f1419] via-[#1a2a4e] to-[#0f1419]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {[
            { icon: Users, label: 'Candidates', value: '0', color: 'orange' },
            { icon: Briefcase, label: 'Shortlisted', value: '0', color: 'blue' },
        ...
        >
          ...
          <ul className="text-left max-w-md mx-auto space-y-2 text-gray-400 mb-8">
            <li>âœ“ Candidate search and filtering</li>
            <li>âœ“ Application review tools</li>
            <li>âœ“ Candidate evaluation and scoring</li>
            <li>âœ“ Hiring analytics and insights</li>
